...
INSERT OR IGNORE INTO page_section (slug, title, content_html, cover_alt) VALUES
  ...
  ('profil-geografis',    'Kondisi Geografis',                '<p>Desa Loji berada pada ketinggian 0 sampai 50 mdpl dengan topografi datar hingga berbukit di bagian utara. Wilayahnya berbatasan langsung dengan Samudra Hindia di sebelah selatan, menjadikannya kaya akan sumber daya kelautan.</p>', NULL),
